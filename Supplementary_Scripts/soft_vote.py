...
eclf1 = VotingClassifier(estimators=estimators1, voting='soft')

eclf1 = eclf1.fit(input4, output4)

joblib.dump(eclf1, "soft_vote.pkl")
...
probs = eclf1.predict_proba(input3)
...
fpr, tpr, threshold = metrics.roc_curve(output3, preds)
